...
int main(void) {
	...
	do
	{
		...
		case 2:
			...
			break;
		case 3:
			controller_editVenta(pArrayListVentas,pArrayListClientes);
			ll_map(pArrayListVentas,ventas_imprimirTodos);
		break;

		case 4:
			controller_cobrarVentas(pArrayListVentas, pArrayListClientes);
			ll_map(pArrayListVentas,ventas_imprimirTodos);
		break;
		case 5:
		...
		case 7:
			do
			{
						...
						" 3)Venta con mas afiches vendidos\n", "error", 1, 4, 2) == 0)
				{
					switch (subMenu) {
						case 1:
							controller_encontrarClienteConMasVentas(pArrayListVentas,pArrayListClientes);
							break;
						case 2:
							controller_encontrarClienteConMenosVentas(pArrayListVentas, pArrayListClientes);
							break;
						case 3:
							controller_findClienteConMasAfiches(pArrayListVentas,pArrayListClientes);
							break;
					}
				}
